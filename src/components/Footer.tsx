        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-white">CV Builder</span>
            </div>
            <p className="text-sm text-stone-400 leading-relaxed max-w-xs">
              Modern ve profesyonel CV oluşturma platformu. AI destekli öneriler ve ATS uyumlu şablonlarla kariyerinizi bir üst seviyeye taşıyın.
            </p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-white mb-3">Ürün</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-white mb-3">Destek</h3>
            <ul className="space-y-2">
              <li><Link href="/contact" className="text-sm text-stone-400 hover:text-white transition-colors">İletişim</Link></li>
              <li><Link href="/faq" className="text-sm text-stone-400 hover:text-white transition-colors">SSS</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-white mb-3">Yasal</h3>
            <ul className="space-y-2">
              <li><Link href="/privacy" className="text-sm text-stone-400 hover:text-white transition-colors">Gizlilik</Link></li>
              <li><Link href="/terms" className="text-sm text-stone-400 hover:text-white transition-colors">Kullanım Şartları</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-10 pt-6 border-t border-stone-700 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-stone-500">© {new Date().getFullYear()} CV Builder. Tüm hakları saklıdır.</p>
          <div className="flex gap-6">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-stone-500 hover:text-white transition-colors" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-stone-500 hover:text-white transition-colors" aria-label="LinkedIn">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-stone-500 hover:text-white transition-colors" aria-label="GitHub">
